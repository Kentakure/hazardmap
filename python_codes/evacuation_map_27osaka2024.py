...
#地図の中心を設定
#https://geoshape.ex.nii.ac.jp/ka/resource/27/271210150.html
center=[34.612358,135.520386]
##OpenStreetMap
...
#大阪府内の避難施設データ
p20gdf27=gpd.read_file('https://japanhazardmap.github.io/DATA/GIS/MLITKSJ/P20Zips/P20-12_27_GML.zip')

#データフレームのカラムのリネーム
df=p20gdf27.rename(columns={
    'P20_001':'行政区域コード',
    'P20_002':'名称',
    'P20_003':'住所',
    'P20_004':'施設の種類',
...
df.to_file('p20osaka.geojson', driver='GeoJSON')
...
# 地図を保存
fmap1.save('evacuation_map_osaka.html')
