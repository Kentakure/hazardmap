...
#地図の中心を設定
#https://geoshape.ex.nii.ac.jp/ka/resource/21/212190890.html
center=[35.883747383471146,137.06690707116422]
##OpenStreetMap
...
#岐阜県内の避難施設データ
p20gdf21=gpd.read_file('https://japanhazardmap.github.io/DATA/GIS/MLITKSJ/P20/P20-12_21.shp')

#データフレームのカラムのリネーム
df=p20gdf21.rename(columns={
    'P20_001':'行政区域コード',
    'P20_002':'名称',
    'P20_003':'住所',
    'P20_004':'施設の種類',
...
df.to_file('p20gifu.geojson', driver='GeoJSON')
...
# 地図を保存
fmap1.save('evacuation_map_gifu.html')
